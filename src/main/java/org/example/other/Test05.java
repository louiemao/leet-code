...
public class Test05 {
    public static void main(String[] args) {
        try {
            ...
            Thread t01 = new Thread(new Test04.MyRunnable("/Users/maoliang/Downloads/1.txt", ids), "线程01");
            Thread t02 = new Thread(new Test04.MyRunnable("/Users/maoliang/Downloads/2.txt", ids), "线程02");
            Thread t03 = new Thread(new Test04.MyRunnable("/Users/maoliang/Downloads/3.txt", ids), "线程03");
            Thread t04 = new Thread(new Test04.MyRunnable("/Users/maoliang/Downloads/4.txt", ids), "线程04");
            t01.start();
            t02.start();
            t03.start();
            t04.start();
